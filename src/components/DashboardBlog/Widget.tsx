...
import { DashboardBlogCharts } from "@components/DashboardBlog/DashboardBlogCharts";
  ...
  return (
    <React.Fragment>
      <div className="col-xl-9">
        <div className="row">
          {blogwidget.map((item: any, idx: any) => (
            <div className="col-lg-3" key={idx}>
              <div className="card">
                <div className="card-body d-flex gap-3 align-items-center">
                  <div className="avatar-sm">
                    <div
                      className={`avatar-title border bg-${item.bgColor}-subtle border-${item.bgColor} border-opacity-25 rounded-2 fs-17`}
                    >
                      <FeatherIcon
                        icon={item.icon}
                        className={`icon-dual-${item.bgColor}`}
                      ></FeatherIcon>
                    </div>
                  </div>
              ...
              <div className="card-body">
                <div>
                  <DashboardBlogCharts
                    ...
                    chartId="column_chart_datalabel"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="card">
              ...
              <div className="card-body">
                {socialShares.map((items, idx) => (
                  <div
                    className={`d-flex gap-2 align-items-center ${items.margin}`}
                    key={idx}
                  >
                    <div className="avatar-xs flex-shrink-0">
                      <div
                        className={`avatar-title bg-${items.textColor}-subtle text-${items.textColor} rounded-2 fs-17`}
                      >
