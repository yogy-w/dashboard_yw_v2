    ...
    <React.Fragment>
                                          ...
                                          {card.prowidth ? (
                                            <div className="mb-3">
                                              ...
                                              <div className="progress rounded-3 progress-sm">
                                                <div
                                                  className={`progress-bar bg-${card.procolor}`}
                                                  role="progressbar"
                                                  style={{
                                                    width: `${card.prowidth}`,
                                                  }}
      ...
      <Modal isOpen={modall} toggle={handleOpen} centered={true}>
        <div className="modal-content border-0">
          <ModalHeader className=" p-3 bg-info-subtle" toggle={handleOpen}>
            Add Board
          </ModalHeader>
          <ModalBody>
            <Form
            ...
            <div className="row mb-3">
              ...
              <Col lg={12} className="mt-3">
                ...
                <SimpleBar style={{ height: "200px" }}>
                  <ul
                    className="list-unstyled vstack gap-2 mb-0"
                    id="taskassignee"
                  >
                      ...
                      return (
                        <li key={index}>
                          <div className="form-check d-flex align-items-center">
                            ...
                            {/* <label className="form-check-label d-flex align-items-center" htmlFor={"member" + image.id}>
                              {image.name}
                            </label>
                            <Image
                              src={image.img}
                ...
                <Flatpickr
                  ...
                  onChange={(botId: any) =>
                    validation.setFieldValue(
                      "botId",
                      moment(botId[0]).format("DD MMMM ,YYYY")
                    )
                  }
              ...
              <div className="form-group mb-4">
                ...
                <div className="col-lg-12">
                  <Select
                    ...
                    id="taginput-choices"
                  ></Select>
                  {validation.touched.badge1 && validation.errors.badge1 ? (
                    <FormFeedback type="invalid" className="d-block">
