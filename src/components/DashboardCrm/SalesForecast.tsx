...
import { SalesForecastCharts } from "@components/DashboardCrm/DashboardCrmCharts";
...
const SalesForecast = () => {
  ...
  // Directly select salesForecastData from Redux state
  const salesForecastData = useSelector(
      ...
      <Col xxl={3} md={6}>
        <Card>
          ...
          <div className="card-body pb-0">
            <div dir="ltr">
              <SalesForecastCharts series={chartData} />
            </div>
          </div>
        </Card>
      </Col>
