              ...
              <div>
                ...
                <h2 className="mt-4 ff-secondary cfs-22 fw-semibold">
                  <span className="counter-value">
                    <CountUp start={0} end={28.05} decimals={1} />0
                  </span>
                  k
                </h2>
                <p className="mb-0 text-muted text-truncate text-wrap">
              ...
              <div>
                ...
                <h2 className="mt-4 ff-secondary cfs-22 fw-semibold">
                  <span className="counter-value" data-target="97.66">
                    <CountUp start={0} end={97.66} decimals={2} />
                  </span>
                  k
                </h2>
                <p className="mb-0 text-muted text-truncate text-wrap">
              ...
              <div>
                ...
                <h2 className="mt-4 ff-secondary cfs-22 fw-semibold">
                  <span className="counter-value" data-target="33.48">
                    <CountUp start={0} end={33.48} decimals={2} />
                  </span>
                  %
                </h2>
                <p className="mb-0 text-muted text-truncate text-wrap">
