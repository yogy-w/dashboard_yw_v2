...
//import Images
const img01 = "/images/sidebar/img-1.jpg";
const img02 = "/images/sidebar/img-2.jpg";
const img03 = "/images/sidebar/img-3.jpg";
const img04 = "/images/sidebar/img-4.jpg";
                  ...
                  {[
                    {
                      ...
                      label: "Default",
                      img: "https://themesbrand.com/velzon/assets/images/demo/default.png",
                    },
                    {
                      id: "customizer-theme02",
                      value: LAYOUT_THEME.SAAS,
                      label: "Sass",
                      img: "https://themesbrand.com/velzon/assets/images/demo/saas.png",
                    },
                    {
                      id: "customizer-theme03",
                      value: LAYOUT_THEME.CORPORATE,
                      label: "Corporate",
                      img: "https://themesbrand.com/velzon/assets/images/demo/corporate.png",
                    },
                    {
                      id: "customizer-theme04",
                      value: LAYOUT_THEME.GALAXY,
                      label: "Galaxy",
                      img: "https://themesbrand.com/velzon/assets/images/demo/galaxy.png",
                    },
                    {
                      id: "customizer-theme05",
                      value: LAYOUT_THEME.MATERIAL,
                      label: "Material",
                      img: "https://themesbrand.com/velzon/assets/images/demo/material.png",
                    },
                    {
                      id: "customizer-theme06",
                      value: LAYOUT_THEME.CREATIVE,
                      label: "Creative",
                      img: "https://themesbrand.com/velzon/assets/images/demo/creative.png",
                    },
                    {
                      id: "customizer-theme07",
                      value: LAYOUT_THEME.MINIMAL,
                      label: "Minimal",
                      img: "https://themesbrand.com/velzon/assets/images/demo/minimal.png",
                    },
                    {
                      id: "customizer-theme08",
                      value: LAYOUT_THEME.MODERN,
                      label: "Modern",
                      img: "https://themesbrand.com/velzon/assets/images/demo/modern.png",
                    },
                    {
                      id: "customizer-theme09",
                      value: LAYOUT_THEME.INTERACTIVE,
                      label: "Interactive",
                      img: "https://themesbrand.com/velzon/assets/images/demo/interactive.png",
                    },
                    {
                      id: "customizer-theme10",
                      value: LAYOUT_THEME.CLASSIC,
                      label: "Classic",
                      img: "https://themesbrand.com/velzon/assets/images/demo/classic.png",
                    },
                    {
                      id: "customizer-theme11",
                      value: LAYOUT_THEME.VINTAGE,
                      label: "Vintage",
                      img: "https://themesbrand.com/velzon/assets/images/demo/vintage.png",
                    },
                  ].map(theme => (
                    <div className="col-6" key={theme.id}>
                      <div className="form-check card-radio">
                        <input
                          id={theme.id}
                          name="data-theme"
                          ...
                          className="form-check-input"
                          value={theme.value}
                          checked={layoutThemeType === theme.value}
                          onChange={e => {
                            if (e.target.checked) {
