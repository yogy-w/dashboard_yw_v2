...
// Crypto Icons
const btcCoin = "/images/svg/crypto-icons/btc.svg";
const ltcCoin = "/images/svg/crypto-icons/ltc.svg";
const etcCoin = "/images/svg/crypto-icons/etc.svg";
const dashCoin = "/images/svg/crypto-icons/dash.svg";
const bnbCoin = "/images/svg/crypto-icons/bnb.svg";
const usdtCoin = "/images/svg/crypto-icons/usdt.svg";
const topartWork = [
  {
    id: 1,
    img: Img1,
