...
//   const [activePrivacyAccordion, setActivePrivacyAccordion] = useState("privacy-collapseTwo");
  ...
  return (
    <>
     {/* ================= HERO SECTION ================= */}
      ...
      {/* =================================================
         SECTION LAIN
         (sementara BIARKAN DI SINI / atau dipindah nanti)
      ================================================== */}
    ...
    // export default LandingPage;
      /* ====== HERO SECTION (copy dari kode kamu) ======
...
>
  <div className="carousel-inner shadow-lg p-2 bg-white rounded">
    {banners.length > 0 ? (
      banners.map((banner) => {
        const imageUrl = banner.Media?.url || "/images/demos/default.png";
