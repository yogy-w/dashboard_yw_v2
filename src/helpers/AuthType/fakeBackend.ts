...
const fakeBackend = () => {
  ...
  mock.onGet(url.GET_OCTSALES_DATA).reply(() => {
    return new Promise(resolve => {
      setTimeout(() => {
        // Return forecast vs actual series
        resolve([200, octSalesForecastData]);
      });
    });
  });
  ...
  mock.onGet(url.GET_NOVSALES_DATA).reply(() => {
    return new Promise(resolve => {
      setTimeout(() => {
        resolve([200, novSalesForecastData]);
      });
    });
  });
  ...
  mock.onGet(url.GET_DECSALES_DATA).reply(() => {
    return new Promise(resolve => {
      setTimeout(() => {
        resolve([200, decSalesForecastData]);
      });
    });
  });
  ...
  mock.onGet(url.GET_JANSALES_DATA).reply(() => {
    return new Promise(resolve => {
      setTimeout(() => {
        resolve([200, janSalesForecastData]);
      });
    });
  });
  // Dashboard Ecommerce
