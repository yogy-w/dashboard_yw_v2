...
// Gets the logged in user data from local session (client-side only)
...
// Dashboard NFT
// Marketplace
export const getAllMarketplaceData = async () =>
  await api.get(url.GET_ALLMARKETPLACE_DATA);
export const getMonthMarketplaceData = async () =>
  await api.get(url.GET_MONTHMARKETPLACE_DATA);
export const gethalfYearMarketplaceData = async () =>
  await api.get(url.GET_HALFYEARMARKETPLACE_DATA);
export const getYearMarketplaceData = async () =>
  await api.get(url.GET_YEARMARKETPLACE_DATA);
